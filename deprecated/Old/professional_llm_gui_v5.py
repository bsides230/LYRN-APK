...
class ProfessionalLLMInterface(ctk.CTk):
    ...
    def create_sidebar(self):
        ...
        self.start_btn = ctk.CTkButton(button_frame, text="▶ Start Jobs", command=self.start_automation)
        self.start_btn.pack(side="left", fill="x", expand=True, padx=(0, 5))
        self.stop_btn = ctk.CTkButton(button_frame, text="⏹ Stop Jobs", command=self.stop_automation)
        ...
        self.eval_label = ctk.CTkLabel(metrics_frame, text="Generation: 0 tok/s", text_color="#8B5FBF")
        ...
        ctk.CTkButton(system_frame, text="⚙ Settings", command=self.open_settings).pack(padx=10, pady=5, fill="x")
        ctk.CTkButton(system_frame, text="🔄 Reload Model", command=self.reload_model).pack(padx=10, pady=5, fill="x")
        ctk.CTkButton(system_frame, text="📁 Clear Chat", command=self.clear_chat).pack(padx=10, pady=(5, 15), fill="x")
        ...
        self.status_label = ctk.CTkLabel(status_frame, text="Ready", text_color="#4ECDC4")
...
"""
    ...
    def open_settings(self):
        try:
            SettingsDialog(self, self.settings_manager)
        except Exception as e:
