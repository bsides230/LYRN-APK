"""
LYRN-AI Interface v6.0 - Advanced GUI with Full Feature Set
...
class TabbedSettingsDialog(ctk.CTkToplevel):
    ...
    def create_widgets(self):
        ...
        ctk.CTkButton(button_frame, text="Save All",
                     command=self.save_all_settings).pack(side="left", padx=10, pady=10)
...
class LyrnAIInterface(ctk.CTk):
    ...
    def setup_window(self):
        ...
        self.title("LYRN-AI Interface v6.0")
    ...
    def create_left_sidebar(self):
        ...
        ctk.CTkButton(system_frame, text="📦 Load Model",
                     font=normal_font, command=self.open_model_selector).pack(padx=10, pady=3, fill="x")
