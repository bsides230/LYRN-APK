"""
LYRN-AI Interface v6.3 - Advanced GUI with Full Feature Set
...
class LyrnAIInterface(ctk.CTk):
    ...
    def setup_window(self):
        ...
        self.title("LYRN-AI Interface v6.3")
    ...
    def create_left_sidebar(self):
        ...
        self.settings_button = ctk.CTkButton(self.system_frame, text="⚙ Settings",
                     font=normal_font, command=self.open_settings)
        self.settings_button.pack(padx=10, pady=3, fill="x")
        Tooltip(self.settings_button, self.tooltips.get("settings_button", ""))

        self.show_llm_log_button = ctk.CTkButton(self.system_frame, text="📋 Show LLM Log",
        ...
        self.clear_chat_button = ctk.CTkButton(self.system_frame, text="📁 Clear Chat",
    ...
    def create_enhanced_status(self):
        ...
        self.status_frame = ctk.CTkFrame(self.left_sidebar, fg_color=self.theme_manager.get_color("status_bg_color", self.theme_manager.get_color("frame_bg")))
    ...
    def apply_color_theme(self):
        ...
        try:
            ...
            if hasattr(self, 'status_frame'):
                self.status_frame.configure(fg_color=tm.get_color("status_bg_color", tm.get_color("frame_bg")))
...
def main():
    """Main entry point for LYRN-AI v6.3"""
    log_queue = queue.Queue()
    redirector = ConsoleRedirector(log_queue)
    redirector.start()

    try:
        print("Starting LYRN-AI Interface v6.3...")
